...
# Image processing backend used by Active Storage variants; loaded on demand by
# image_processing so booting does not require libvips [https://github.com/libvips/ruby-vips]
...
group :development do
  ...
  # Annotate models and related files with the database schema [https://github.com/drwl/annotaterb]
  gem "annotaterb"
end
