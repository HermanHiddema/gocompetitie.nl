...
Models, fixtures and model tests carry a schema summary that is generated by
[annotaterb](https://github.com/drwl/annotaterb). The annotations are refreshed
automatically when migrations run in development and can be regenerated with:
